...
function useCommandLine() {
    var _a = React.useState(defaultState$3.inputValue), inputValue = _a[0], setInputValue = _a[1];
    var _b = React.useState(defaultState$3.renderValue), renderValue = _b[0], setRenderValue = _b[1];
    var _c = React.useState(defaultState$3.cursorPosition), cursorPosition = _c[0], setCursorPosition = _c[1];
...
function usePrinter(_a) {
    ...
    var _b = React.useState(false), isPrinting = _b[0], setIsPrinting = _b[1];
    var _c = React.useState(null), activeTimeout = _c[0], setActiveTimeout = _c[1];
    var _d = React.useState(defaultState$1), printerResponse = _d[0], setPrinterResponse = _d[1];
...
})(exports.WordTypes || (exports.WordTypes = {}));
...
var commandWord = function (_a) {
    ...
    return ({
        type: exports.WordTypes.COMMAND,
        characters: characters,
        prompt: prompt,
        dataAttribute: dataAttribute,
        className: className,
...
var commandLine = function (_a) {
    ...
    return ({
        type: exports.LineTypes.COMMAND,
        words: words,
        dataAttribute: dataAttribute,
        className: className,
        id: id,
...
exports.PrinterEvents = void 0;
(function (PrinterEvents) {
    PrinterEvents["PRINT"] = "PRINT";
    PrinterEvents["CLEAR"] = "CLEAR";
})(exports.PrinterEvents || (exports.PrinterEvents = {}));
var defaultQueue$2 = [];
function usePrinterQueue() {
    var queue = React.useRef(defaultQueue$2).current;
    var _a = React.useState(__spreadArray([], defaultQueue$2, true)), queueState = _a[0], setQueueState = _a[1];
    ...
    var print = function (payload) {
        enqueue({
            type: exports.PrinterEvents.PRINT,
            payload: payload,
        });
    };
    var clear = function () {
        enqueue({
            type: exports.PrinterEvents.CLEAR,
        });
    };
    return {
        state: queueState,
...
exports.TerminalEvents = void 0;
(function (TerminalEvents) {
    TerminalEvents["FOCUS"] = "FOCUS";
    TerminalEvents["LOCK"] = "LOCK";
    TerminalEvents["LOADING"] = "LOADING";
})(exports.TerminalEvents || (exports.TerminalEvents = {}));
var defaultQueue$1 = [];
function useTerminalQueue() {
    var queue = React.useRef(defaultQueue$1).current;
    var _a = React.useState(__spreadArray([], defaultQueue$1, true)), queueState = _a[0], setQueueState = _a[1];
    var enqueue = function (event) {
        queue.push(event);
        setQueueState(__spreadArray([], queue, true));
    };
    ...
    var focus = function () {
        enqueue({
            type: exports.TerminalEvents.FOCUS,
        });
    };
    var lock = function (payload) {
        enqueue({
            type: exports.TerminalEvents.LOCK,
            payload: payload,
        });
    };
    var loading = function (payload) {
        enqueue({
            type: exports.TerminalEvents.LOADING,
            payload: payload,
        });
    };
    return {
...
function useEventQueue() {
    var queue = React.useRef(defaultQueue).current;
    var _a = React.useState(__spreadArray([], defaultQueue, true)), queueState = _a[0], setQueueState = _a[1];
    var enqueue = function (event) {
        queue.push(event);
        setQueueState(__spreadArray([], queue, true));
    };
...
function useTerminalController(_a) {
    ...
    var _m = React.useState(false), lockedByLoader = _m[0], setLockedByLoader = _m[1];
    var focus = function () {
        focusInput();
    };
    ...
    var handleKeyboardEvent = function (key) {
        ...
        if (isSubmitActions(key)) {
            ...
            enqueue({ type: exports.PrinterEvents.PRINT, payload: [printCommandLine({ characters: characters, prompt: prompt })] });
    ...
    React.useEffect(function () {
        if (banner && !loaded.current) {
            loaded.current = true;
            enqueue({ type: exports.PrinterEvents.PRINT, payload: banner });
        }
        if (focusOnMount) {
            focusInput();
        }
...
function useTerminalApp() {
    var _a = React.useState(defaultState.inputLocked), inputLocked = _a[0], setInputLocked = _a[1];
...
function useSubscribePrinterQueue(_a) {
    ...
    var _e = React.useState(null), activeEvent = _e[0], setActiveEvent = _e[1];
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    _a = event.type;
                    switch (_a) {
                        case exports.PrinterEvents.CLEAR: return [3 /*break*/, 1];
                        case exports.PrinterEvents.PRINT: return [3 /*break*/, 2];
                    }
                    return [3 /*break*/, 4];
                case 1:
                    clear();
...
function useSubscribeTerminalQueue(_a) {
    ...
    var interpretEvent = function (event) {
        switch (event.type) {
            case exports.TerminalEvents.FOCUS:
                focus();
                dequeue(nullifyActiveEvent);
                break;
            case exports.TerminalEvents.LOADING:
                loading(event.payload);
                dequeue(nullifyActiveEvent);
                break;
            case exports.TerminalEvents.LOCK:
                lock(event.payload);
                dequeue(nullifyActiveEvent);
                break;
        }
...
function useSubscribeEventQueue(_a) {
    ...
    var _d = React.useState(null), activeEvent = _d[0], setActiveEvent = _d[1];
    var nullifyActiveEvent = function () { return setActiveEvent(null); };
    ...
    var interpretEvent = function (event) {
        switch (event.type) {
            ...
            case exports.TerminalEvents.LOCK:
                ...
                dequeue(nullifyActiveEvent);
                break;
            case exports.PrinterEvents.CLEAR:
                printerClear();
                dequeue(nullifyActiveEvent);
                break;
            case exports.PrinterEvents.PRINT:
...
function useLoader(_a) {
    ...
    var _c = React.useState(DEFAULT_SLIDE_INDEX), slideIndex = _c[0], setSlide = _c[1];
    var _d = React.useState(null), activeTimeout = _d[0], setActiveTimeout = _d[1];
    var clearTimeoutState = function () {
        if (activeTimeout) {
            clearTimeout(activeTimeout);
            setActiveTimeout(null);
    ...
    React.useEffect(function () { return function () { return clearTimeoutState(); }; }, 
    // disabled due to inner structure: should be equal to "onBeforeUnmount"
    // eslint-disable-next-line react-hooks/exhaustive-deps
    []);
    return {
...
var PrinterLine = function PrinterLine(_a) {
    ...
    return (function () {
        switch (line.type) {
            case exports.LineTypes.TEXT:
                return (React__default["default"].createElement("div", { id: id, className: [classes$7.textLine, 'crt-text-line', className].join(' '), "data-crt-terminal": dataAttribute }, children));
            case exports.LineTypes.COMMAND:
                return (React__default["default"].createElement("div", { id: id, className: [classes$7.commandLine, 'crt-command-line', className].join(' '), "data-crt-terminal": dataAttribute }, children));
            default:
...
var Character = function Character(_a) {
    ...
    return (React__default["default"].createElement("span", { className: [classes$6.character, selectedStyle, className, 'crt-character'].join(' ') }, children));
};
...
var PrinterWord = function PrinterWord(_a) {
    ...
    return (function () {
        switch (word.type) {
            case exports.WordTypes.TEXT:
                return (React__default["default"].createElement("span", { id: id, className: [classes$5.textWord, 'crt-text-word', className].join(' '), "data-crt-terminal": dataAttribute },
                    React__default["default"].createElement(Character, null, children)));
            case exports.WordTypes.ANCHOR:
                return (React__default["default"].createElement("a", { id: id, className: [classes$5.anchorWord, 'crt-anchor-word', className].join(' '), "data-crt-terminal": dataAttribute, href: word.href, onClick: word.onClick },
                    React__default["default"].createElement(Character, null, children)));
            case exports.WordTypes.BUTTON:
                return (React__default["default"].createElement("button", { type: "button", id: id, className: [classes$5.buttonWord, 'crt-button-word', className].join(' '), "data-crt-terminal": dataAttribute, onClick: word.onClick },
                    React__default["default"].createElement(Character, null, children)));
            case exports.WordTypes.COMMAND:
                return (React__default["default"].createElement("span", { id: id, className: [classes$5.commandWord, 'crt-command-word', className].join(' '), "data-crt-terminal": dataAttribute },
                    React__default["default"].createElement(Character, null, word.prompt),
                    React__default["default"].createElement(Character, null, children)));
            default:
...
var TerminalScreen = React.memo(function (_a) {
    var state = _a.state;
    return (React__default["default"].createElement("div", { className: "crt-screen" }, state.map(function (line, lineIndex) { return (React__default["default"].createElement(PrinterLine, { line: line, key: lineIndex }, line.words.map(function (word, wordIndex) { return (React__default["default"].createElement(PrinterWord, { word: word, key: wordIndex }, word.characters)); }))); })));
});
...
var Overlay = function Overlay(_a) {
    ...
    return (React__default["default"].createElement("div", { className: [classes$4.overlay, 'crt-overlay'].join(' ') },
        scanner && React__default["default"].createElement("div", { className: [classes$4.scanner, 'crt-scanner'].join(' ') }),
        pixels && React__default["default"].createElement("div", { className: [classes$4.pixels, 'crt-pixels'].join(' ') })));
};
...
var TextEffects = function TextEffects(_a) {
    ...
    return (React__default["default"].createElement(React__default["default"].Fragment, null, enabled ? (React__default["default"].createElement("div", { className: [classes$3.textEffects, 'crt-text-effects'].join(' ') }, children)) : (children)));
};
...
var ScreenEffects = function ScreenEffects(_a) {
    var enabled = _a.enabled, children = _a.children;
    return (React__default["default"].createElement(React__default["default"].Fragment, null, enabled ? (React__default["default"].createElement("div", { className: [classes$2.screenEffects, 'crt-screen-effects'].join(' ') }, children)) : (children)));
};
...
var CommandLine = React__default["default"].forwardRef(function (_a, inputElement) {
    ...
    return (React__default["default"].createElement("div", { className: [classes$1.commandLine, 'crt-command-line'].join(' ') },
        React__default["default"].createElement("span", { className: "crt-command-line__prompt" }, prompt),
        React__default["default"].createElement("div", { className: [classes$1.inputWrap, 'crt-command-line__input-wrapper'].join(' ') },
...
var Terminal = function Terminal(_a) {
    ...
    return (React__default["default"].createElement("label", { className: [classes.terminal, 'crt-terminal'].join(' '), htmlFor: "crt-command-line-input" },
        React__default["default"].createElement(Overlay, { scanner: scanner, pixels: pixels }),
        React__default["default"].createElement(ScreenEffects, { enabled: screenEffects },
            React__default["default"].createElement("div", { ref: terminalRef, className: [classes.overflowContainer, 'crt-terminal__overflow-container'].join(' ') },
                React__default["default"].createElement(TextEffects, { enabled: textEffects },
...
exports.anchorWord = anchorWord;
exports.buttonWord = buttonWord;
exports.commandLine = commandLine;
exports.commandWord = commandWord;
exports.textLine = textLine;
exports.textWord = textWord;
exports.useEventQueue = useEventQueue;
